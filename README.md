...
<div align="center" style="text-align:center;padding:21px 0 21px 0;">
  <a href="https://www.linkedin.com/in/nithish-gowda/" target="_blank" style="display:inline-block;background:#000000;border:1.5px solid #ffffff;border-radius:12px;line-height:39px;padding:0 16px 0 3px;text-decoration:none;margin:0 20px 12px 0;"><span style="background:#111111;border-radius:10px;padding:5px;margin-right:9px;vertical-align:middle;"><img src="assets/icons/linkedin.svg" width="20" height="20" alt="" style="vertical-align:middle;"></span><span style="color:#ffffff;font-size:16px;font-weight:700;vertical-align:middle;">LinkedIn</span></a>
  <a href="https://leetcode.com/u/nghn0/" target="_blank" style="display:inline-block;background:#000000;border:1.5px solid #ffffff;border-radius:12px;line-height:39px;padding:0 16px 0 3px;text-decoration:none;margin:0 20px 12px 0;"><span style="background:#111111;border-radius:10px;padding:5px;margin-right:9px;vertical-align:middle;"><img src="assets/icons/leetcode.svg" width="20" height="20" alt="" style="vertical-align:middle;"></span><span style="color:#ffffff;font-size:16px;font-weight:700;vertical-align:middle;">LeetCode</span></a>
  <a href="https://github.com/nghn0" target="_blank" style="display:inline-block;background:#000000;border:1.5px solid #ffffff;border-radius:12px;line-height:39px;padding:0 16px 0 3px;text-decoration:none;margin:0 20px 12px 0;"><span style="background:#111111;border-radius:10px;padding:5px;margin-right:9px;vertical-align:middle;"><img src="assets/icons/portfolio.svg" width="20" height="20" alt="" style="vertical-align:middle;"></span><span style="color:#ffffff;font-size:16px;font-weight:700;vertical-align:middle;">Portfolio</span></a>
  <a href="mailto:nithish.gowda@gmail.com" target="_blank" style="display:inline-block;background:#000000;border:1.5px solid #ffffff;border-radius:12px;line-height:39px;padding:0 16px 0 3px;text-decoration:none;margin:0 0 12px 0;"><span style="background:#111111;border-radius:10px;padding:5px;margin-right:9px;vertical-align:middle;"><img src="assets/icons/gmail.svg" width="20" height="20" alt="" style="vertical-align:middle;"></span><span style="color:#ffffff;font-size:16px;font-weight:700;vertical-align:middle;">Gmail</span></a>
</div>
<!-- ABOUT -->
