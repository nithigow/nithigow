...
<div align="center" style="text-align:center;padding:21px 0 21px 0;">
  <a href="https://www.linkedin.com/in/nithish-gowda/" target="_blank" style="display:inline-block;width:148px;background:#0a0a0a;border:1px solid #2a2a2a;border-radius:7px;padding:14px 0;text-align:center;text-decoration:none;margin:0 7px 12px 7px;"><img src="assets/icons/linkedin.svg" width="16" height="16" alt="" style="vertical-align:middle;margin-right:8px;"><span style="color:#ffffff;font-size:13px;font-weight:600;letter-spacing:2px;text-transform:uppercase;vertical-align:middle;line-height:16px;">LINKEDIN</span></a>
  <a href="https://github.com/nghn0" target="_blank" style="display:inline-block;width:148px;background:#0a0a0a;border:1px solid #2a2a2a;border-radius:7px;padding:14px 0;text-align:center;text-decoration:none;margin:0 7px 12px 7px;"><img src="assets/icons/resume.svg" width="16" height="16" alt="" style="vertical-align:middle;margin-right:8px;"><span style="color:#ffffff;font-size:13px;font-weight:600;letter-spacing:2px;text-transform:uppercase;vertical-align:middle;line-height:16px;">RESUME</span></a>
  <a href="https://leetcode.com/u/nghn0/" target="_blank" style="display:inline-block;width:148px;background:#0a0a0a;border:1px solid #2a2a2a;border-radius:7px;padding:14px 0;text-align:center;text-decoration:none;margin:0 7px 12px 7px;"><img src="assets/icons/leetcode.svg" width="16" height="16" alt="" style="vertical-align:middle;margin-right:8px;"><span style="color:#ffffff;font-size:13px;font-weight:600;letter-spacing:2px;text-transform:uppercase;vertical-align:middle;line-height:16px;">LEETCODE</span></a>
  <a href="https://github.com/nghn0" target="_blank" style="display:inline-block;width:148px;background:#0a0a0a;border:1px solid #2a2a2a;border-radius:7px;padding:14px 0;text-align:center;text-decoration:none;margin:0 7px 12px 7px;"><img src="assets/icons/portfolio.svg" width="16" height="16" alt="" style="vertical-align:middle;margin-right:8px;"><span style="color:#ffffff;font-size:13px;font-weight:600;letter-spacing:2px;text-transform:uppercase;vertical-align:middle;line-height:16px;">PORTFOLIO</span></a>
  <a href="mailto:nithish.gowda@gmail.com" target="_blank" style="display:inline-block;width:148px;background:#0a0a0a;border:1px solid #2a2a2a;border-radius:7px;padding:14px 0;text-align:center;text-decoration:none;margin:0 7px 12px 7px;"><img src="assets/icons/gmail.svg" width="16" height="16" alt="" style="vertical-align:middle;margin-right:8px;"><span style="color:#ffffff;font-size:13px;font-weight:600;letter-spacing:2px;text-transform:uppercase;vertical-align:middle;line-height:16px;">EMAIL</span></a>
</div>
<!-- ABOUT -->
